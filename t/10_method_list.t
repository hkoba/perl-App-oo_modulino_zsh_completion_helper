...

{
  ...
  is(scalar qx($cmdFn zsh_methods pmfile $testFn)
     , <<END, "All methods");
hello
hi
END

  is(scalar qx($cmdFn zsh_methods pmfile $testFn CURRENT 1 words '["he"]')
...
END
  ...
  is(scalar qx($cmdFn zsh_methods pmfile $testFn NUMERIC 1)
